	...
	return (
		<section id="section1" className="about">
			<div className="container">
				<div className="row">
					<div className="col-12 align-centre">
						<h2 className="about__title uppercase">About Me</h2>
					</div>
					...
					<div className="col-12 col-md-6">
						...
						<p>🍸 I surprisingly do not like coffee - but I absolutely love an Espresso Martini! Nothing beats a Dirty Banana though, while sitting back relaxing on the beautiful white sanded beaches of Jamaica, you will catch me there from time to time.</p>
